...
.. note::
  ...
  If a network is not available, create a new network which **VLAN ID 0**, like you have done before. Without a network, nothing will work. Also make sure that you are communicating with your other cluster users who is going to create the network.
